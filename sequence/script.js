...
for(C=1;C<40;C++){
Seq.push(Seq[Seq.length-1]+Seq[Seq.length-2])}  //fills in array
}
...
if(!isGeo(Sub)){document.write("ごめんなさい、現在の私の知識ではわかりません…");
}   
...
var U=Number(T)+1;
document.write("<br>a<sub>"+U+"</sub>= "+Seq[T])}/*lists all the nums in sequence*/
